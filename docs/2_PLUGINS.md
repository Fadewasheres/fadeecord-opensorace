...
You don't need to run `pnpm build` every time you make a change. Instead, use `pnpm watch` - this will auto-compile Fadecord whenever you make a change. If using code patches (recommended), you will need to CTRL+R to load the changes.
...
## How Plugins Work In Fadecord

Fadecord uses a different way of making mods than you're used to.
...
If you want to publish your plugin into the Fadecord repo, move your plugin from `src/userplugins` into the `src/plugins` folder and open a PR!
