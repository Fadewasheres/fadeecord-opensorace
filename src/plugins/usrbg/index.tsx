...
const BASE_URL = "https://pfps.fadecord.online/meow/banner.json";

let data = {} as Record<string, string>;

const settings = definePluginSettings({
    nitroFirst: {
        description: "Banner to use if both Nitro and FadeBG banners are present",
        type: OptionType.SELECT,
        options: [
            { label: "Nitro banner", value: true, default: true },
            { label: "FadeBG banner", value: false },
        ]
    },
    voiceBackground: {
        description: "Use FadeBG banners as voice chat backgrounds",
...
export default definePlugin({
    name: "FadeBG",
    description: "Displays user banners from FadeBG, allowing anyone to get a banner without Nitro",
    ...
    settingsAboutComponent: () => {
        return (
            <Link href="https://github.com/AutumnVN/FadeBG#how-to-request-your-own-FadeBG-banner">CLICK HERE TO GET YOUR OWN BANNER</Link>
        );
    },
