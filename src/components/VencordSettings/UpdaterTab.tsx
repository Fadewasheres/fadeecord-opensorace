...
function Updater() {
    ...
    return (
        <SettingsTab title="Fadecord Updater">
            ...
            <Switch
                ...
                note="Automatically update Fadecord without confirmation prompt"
            >
            ...
            <Switch
                ...
                note="Shows a notification when Fadecord automatically updates"
                disabled={!settings.autoUpdate}
            >
